...
export default defineConfig({
  ...
  head: [
    ["link", { rel: "icon", type: "image/svg+xml", href: "/deskapp/favicon.svg" }],
    ["link", { rel: "icon", type: "image/png", sizes: "96x96", href: "/deskapp/favicon-96x96.png" }],
    ["link", { rel: "icon", href: "/deskapp/favicon.ico", sizes: "any" }],
    ["link", { rel: "apple-touch-icon", sizes: "180x180", href: "/deskapp/apple-touch-icon.png" }],
    ["link", { rel: "manifest", href: "/deskapp/site.webmanifest" }],
    [
      "style",
      {},
